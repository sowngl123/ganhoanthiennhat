    ...
    <div class="bodyy">
        <div class="cardd">
            <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
                <i class="checkmarkk">X</i>
            </div>
            <h1 class="titlee">Đăng ký không thành công</h1>
            <p class="textt">
                Email hoặc số điện thoại của bạn đã đặt một tour trước đó<br/>
                Chúng tôi sẽ xử lý tour của bạn trong thời gian sớm nhất!
            </p><br/>
