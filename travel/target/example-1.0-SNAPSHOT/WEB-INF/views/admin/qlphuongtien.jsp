                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <c:forEach var="qlphuongtien" items="${qlphuongtiens}">
                                    <tr>
                                        <td>${qlphuongtien.tenPhuongTien}</td>
                                        <td>${qlphuongtien.loaiPhuongTien}</td>
                                        <td>${qlphuongtien.soChoNgoi}</td>
                                        <td>${qlphuongtien.khoangGiaDau}</td>
                                        <td>${qlphuongtien.khoangGiaCuoi}</td>
                                        <td>${qlphuongtien.lienLacSDT}</td>
                                        <td>${qlphuongtien.thoiGianDiChuyen}</td>
                                        <td>${qlphuongtien.trangThai}</td>
