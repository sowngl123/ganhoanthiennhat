                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <c:forEach var="image" items="${images}">
                                    <tr>
                                        ...
                                        <td> <img width="150px" height="100px" src="${image.image_Url}"> </td>
                                        <td>${image.image_Time}</td>
                                        <td style="display: flex">
                                            <input type="hidden" name="image_Time" value="${image.image_Time}">
                                            <button type="button" class="btn btn-circle" style="margin-right: 10px"
                                                    id="btn-edit" onclick="updateImage(${image.image_Id})">
                            ...
                            <form id="form_validation" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label">Địa chỉ ảnh/URL</label>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#btn-save').on('click', function () {
            ...
            if (image_Id !== "") {
                form_validation.attr('action', '/admin/image/update');
            } else {
                form_validation.attr('action', '/admin/image/create');
            }
            form_validation.submit();
        });
        $('#button-save').on('click', function () {
            clearDataForInputText($('#image_Id'), "");
            clearDataForInputText($('#image_Url'), "");
            clearDataForInputText($('#image_Time'), "");
    ...
    function updateImage(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                setDataForInputText(image_Url, data.image_Url);
                setDataForInputText(image_Time, data.image_Time);
                setDataForInputText(image_Id, data.image_Id);
                $('#exampleModalCenter').modal('toggle');
            },
