        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST" action="/admin/accommodation/" enctype="multipart/form-data">
                            <div class="text-center">
                                <div class="profile-img">
                                    <img src="data:image;base64,${tour.base64Image}"
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="tour_Departureday" value="<f:formatDate value="${tour.tour_Departureday}" pattern="dd/MM/yyyy" />"
                                           required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="tour_Enddate" value="<f:formatDate value="${tour.tour_Enddate}" pattern="dd/MM/yyyy" />"
                                           required>
                            ...
                            <input hidden  name="vehicle" id="IDvehicle" value="${tour.tour_Vehicle}">

                            <div class="form-group form-float">
                                <div class="form-inline">
                                    <select class="form-control show-tick" id="IDtour_Vehicle" name="tour_Vehicle" required>
                                        <option value="">-- Chọn phương tiện --</option>
                                        <option value="0">Ô tô</option>
                                        <option value="1">Máy bay</option>
                                        <option value="2">Máy bay + Ô tô</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-float">
                                <div class="form-inline">
                                    <select class="form-control show-tick" id="IDtour_Status" name="tour_Status" required>
