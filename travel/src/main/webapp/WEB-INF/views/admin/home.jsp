                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <c:forEach var="user" items="${users}">
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${user.user_Gender == 0}">
                                                    <p>Nữ</p>
                                                </c:when>
                                        ...
                                        <td><f:formatDate value="${user.user_Createdate}" pattern="dd/MM/yyyy" /></td>
                                        <td><f:formatDate value="${user.user_Lastupdate}" pattern="dd/MM/yyyy" /></td>
                                        <td>
                                            <c:choose>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Thêm / Cập nhật thông tin tài khoản</h5>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-inline">
                                        <select class="form-control show-tick" id="user_Status" name="user_Status" required>
