                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <c:forEach var="accommodation" items="${accommodations}">
                                    <tr>
                                        ...
                                        <td><f:setLocale value="vi-VN"/> <f:formatNumber type="number" value="${accommodation.accommodation_Price}" />VNĐ</td>
                                        <td>${accommodation.accommodation_Phone}</td>
                                        <td>${accommodation.accommodation_Link}</td>
                                        <td><f:formatDate value="${accommodation.accommodation_Time}" pattern="dd/MM/yyyy" /></td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Thêm / Cập nhật thông tin khách sạn</h5>
