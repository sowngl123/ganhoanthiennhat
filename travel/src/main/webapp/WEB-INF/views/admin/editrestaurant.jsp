...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>
                BẢNG THÔNG TIN CHI TIẾT NHÀ HÀNG
            </h2>
        </div>
        <!-- Basic Examples -->
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST" action="/admin/editrestaurant/" enctype="multipart/form-data">
                            <div class="text-center">
                                <div class="profile-img">
                                    <img src="data:image;base64,${restaurant2.base64Image}"
                                         class="avatar img-thumbnail"
                                         alt="avatar" height="10%" width="40%">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="restaurant_Name" value="${restaurant2.restaurant_Name}"
                                           required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="restaurant_Owners"
                                           value="${restaurant2.restaurant_Owners}" required>
                                    <label class="form-label">Chủ nhà hàng</label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="restaurant_Price" value="${restaurant2.restaurant_Price}"
                                           required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="restaurant_Phone" value="${restaurant2.restaurant_Phone}"
                                           required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="restaurant_Link" value="${restaurant2.restaurant_Link}" />"
                                           required>
                                    <label class="form-label">Link trang wed</label>
                                </div>
                            </div>
                            ...
                            <c:choose>
                                <c:when test="${not empty restaurant2}">
                                    <input type="hidden" name="action" value="update">
                                    <input type="hidden" name="restaurant_Id" value="${restaurant2.restaurant_Id}">
                                </c:when>
                                <c:otherwise>
