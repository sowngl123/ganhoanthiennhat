...
//                    sendMail(bookTourDto, tourDto);
    ...
    private void sendMailNewUser(BookTourDto bookTourDto, TourDto tourDto, String pass) {
        try {
            DecimalFormat df = new DecimalFormat("###,###,###,###,###");
            df.setMaximumIntegerDigits(12);
            ...
            String emailBody = "<!DOCTYPE html>\n" +
                    ...
                    "\t\t\t\t\t\t\t\t\t\t\t\n" +
                    "\t\t\t\t\t\t\t\t\t\t</h4>\n" +
                    "\t\t\t\t\t\t\t\t\t\t<h4>Quý khách có thể đăng nhập vào trang web để có thể theo dõi tour với tài khoản:<br/>\n" +
                    "\t\t\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;- Số điện thoại: " + bookTourDto.getPhone() + "<br/>\n" +
                    "\t\t\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;- Mật khẩu: " + pass + "<br/>\n" +
                    "\t\t\t\t\t\t\t\t\t\t</h4>\n" +
                    "\t\t\t\t\t\t\t\t\t</div>\n" +
                    "\t\t\t\t\t\t\t\t</td>\n" +
                    ...
                    "\t\t\t\t\t\t</tr>\n" +
                    "\t\t\t\t\t\t<tr style=\"border-bottom: 1px solid rgba(0,0,0,.05);\">\n" +
                    "\t\t\t\t\t\t\t<td style=\"width: 50%; text-align:left; padding: 0 2.5em;\">\n" +
                    ...
                    "\t\t\t\t\t\t\t\t<p><a href=\"http://localhost:8080/\" class=\"btn btn-primary\">Xem thông tin tour</a></p>\n" +
                    "\t\t\t\t\t\t\t</td>\n" +
                    "\t\t\t\t\t\t</tr>\n" +
                    "\t\t\t\t\t</table>\n" +
                    "\t\t\t\t</tr>\n" +
    ...
    private void sendMail(BookTourDto bookTourDto, TourDto tourDto) {
        try {
            ...
            String emailBody = "<!DOCTYPE html>\n" +
                    ...
                    "\t\t\t\t\t\t\t\t\t\t\t\n" +
                    "\t\t\t\t\t\t\t\t\t\t</h4>\n" +
                    "\t\t\t\t\t\t\t\t\t\t<h4>Quý khách có thể đăng nhập vào trang web để có thể theo dõi tour với số điện thoại: " + bookTourDto.getPhone() + "<br/>\n" +
                    "\t\t\t\t\t\t\t\t\t\t</h4>\n" +
                    "\t\t\t\t\t\t\t\t\t</div>\n" +
                    "\t\t\t\t\t\t\t\t</td>\n" +
                    "\t\t\t\t\t\t\t</tr>\n" +
