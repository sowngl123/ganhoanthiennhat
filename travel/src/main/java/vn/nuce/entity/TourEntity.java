...
public class TourEntity implements Serializable {
    ...
    private Timestamp tour_Departureday;
    @Column(name = "tour_Enddate")
    private Timestamp tour_Enddate;
    ...
    public Timestamp getTour_Departureday() {
        return tour_Departureday;
    }

    public void setTour_Departureday(Timestamp tour_Departureday) {
        this.tour_Departureday = tour_Departureday;
    }

    public Timestamp getTour_Enddate() {
        return tour_Enddate;
    }

    public void setTour_Enddate(Timestamp tour_Enddate) {
