                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" id="restaurant_Image" name="restaurant_Image" required>
...
<script>
    $(document).ready(function () {
        ...
        $('#button-save').on('click', function () {
            ...
            clearDataForInputText($('#restaurant_Image'), "");
    ...
    function updateRestaurant(id) {
        ...
        let restaurant_Image = $('#restaurant_Image');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                setDataForInputText(restaurant_Image, data.restaurant_Image);
