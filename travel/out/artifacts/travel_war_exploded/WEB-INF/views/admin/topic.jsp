                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex">
                                            <button type="button" class="btn btn-circle" style="margin-right: 10px"
                                                    id="btn-edit" onclick="updateTopic(${topic.topic_ID})">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Thêm / Cập nhật thông tin chủ đề</h5>
...
<script>
    $(document).ready(function () {
        ...
        $('#btn-save').on('click', function () {
            ...
            if (topic_ID !== "") {
                form_validation.attr('action', '/admin/topic/update');
            } else {
                form_validation.attr('action', '/admin/topic/create');
            }
            form_validation.submit();
        });
        $('#button-save').on('click', function () {
            clearDataForInputText($('#topic_Name'), "");
            clearDataForInputText($('#topic_ID'), "");
    ...
    function updateTopic(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                setDataForInputText(topic_Name, data.topic_Name);
                setDataForInputText(topic_ID, data.topic_ID);
                $('#exampleModalCenter').modal('toggle');
            },
