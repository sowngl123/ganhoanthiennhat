                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" id="accommodation_Image" name="accommodation_Image" required>
...
<script>
    $(document).ready(function () {
        ...
        $('#button-save').on('click', function () {
            ...
            clearDataForInputText($('#accommodation_Image'), "");
    ...
    function updateAccommodation(id) {
        ...
        let accommodation_Image = $('#accommodation_Image');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                setDataForInputText(accommodation_Image, data.accommodation_Image);
