                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable"
                                    ...
                                    <c:forEach var="tour" items="${tours}">
                                        <tr>
                                            ...
                                            <td><f:setLocale value="vi-VN"/> <f:formatNumber type="number" value="${tour.tour_Price}" /> đ</td>
                                            <td><f:formatDate value="${tour.tour_Createdate}" pattern=" HH:MM dd/MM/yyyy" /></td>
                                            <td>
                                                <c:choose>
